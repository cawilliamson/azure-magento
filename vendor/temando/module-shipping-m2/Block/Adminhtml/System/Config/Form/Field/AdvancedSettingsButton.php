...
/**
 * Advanced Settings button in module configuration
 *
 ...
 * @api
 */
class AdvancedSettingsButton extends Field
{
    /**
    ...
    {
        return $this->_urlBuilder->getUrl('temando/settings_advanced/edit');
    }
}
